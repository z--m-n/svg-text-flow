...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Translate text flow in SVG documents from foreignObject to flowRoot.')
    parser.add_argument("-i", nargs=1, metavar=('ifile'),
                            help="input svg", type=str,
                            const='', type=str)
    parser.add_argument("-o", nargs=1, metavar=('ofile'),
